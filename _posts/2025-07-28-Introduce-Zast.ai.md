...
- As of July 28th, we have submitted **78** vulnerabilities.
  ...
  ![Vulnerability submissions growth on VulDB.com]({{'/assets/img/vuldb/growth.png' | relative_url }}){: .align-center}

- This effort has made ZAST.AI the **#1** global contributor to VulDB for the month of July, 2025.

  ![ZAST.AI vulnerability submissions on VulDB.com]({{'/assets/img/vuldb/number1.png' | relative_url }}){: .align-center}
...
- In just over a week, ZAST.AI has reached **#37** among all-time global contributors on [VulDB.com](https://vuldb.com/).
  ...
  ![Star count distribution of affected repositories]({{'/assets/img/vuldb/starpie.png' | relative_url }}){: .align-center}
